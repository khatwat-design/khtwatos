...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div
            ...
            class="mobile-sheet-backdrop sm:bg-black/50"
            @click.self="showSubscriptionModal = false"
        >
            <div
                class="glass-modal mobile-sheet-panel mobile-sheet-panel--lg p-4 shadow-2xl sm:p-5"
            >
                <div class="flex items-center justify-between gap-2">
        ...
        >
            <div
                class="glass-modal mobile-sheet-panel mobile-sheet-panel--md p-4 shadow-2xl sm:p-5"
            >
                <div class="flex items-center justify-between gap-2">
