...
class GoodsCustomerController extends Controller
{
    ...
    public function index(Request $request): Response|RedirectResponse
    {
        ...
        $metaDateFrom = $request->query('meta_date_from', '');
        $metaDateTo = $request->query('meta_date_to', '');
        ...
        $metaLeadsQuery = GoodsMetaLead::query()
            ...
            ->when($metaDateFrom !== '', fn ($q) => $q->whereDate('lead_created_at', '>=', $metaDateFrom))
            ->when($metaDateTo !== '', fn ($q) => $q->whereDate('lead_created_at', '<=', $metaDateTo))
        ...
        return Inertia::render('Goods/Index', [
            ...
            'meta_leads' => $metaLeads->map(fn (GoodsMetaLead $lead) => [
                ...
                'city' => $lead->form_answers['city'] ?? null,
            ...
            'meta_filters' => [
                ...
                'date_from' => $metaDateFrom !== '' ? $metaDateFrom : null,
                'date_to' => $metaDateTo !== '' ? $metaDateTo : null,
